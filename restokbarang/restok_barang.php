...
$query = "
    SELECT 
        ...
        b.stok, 
        r.jumlah, 
        r.tanggal_restok,    -- jangan lupa koma di sini
        r.harga_beli,        -- dari restokbarang (alias r)
        r.keuntungan         -- dari restokbarang (alias r)
    FROM restokbarang r
    ...
    <div class="table-wrapper">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
		        ...
		        <td><?= number_format($row['keuntungan'], 2, ',', '.') ?>%</td>
